...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript(maccms.path+"/template/free1.0_wap/js/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript(maccms.path+"/template/free1.0_wap/js/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
		...
		qrcode: function() {
			$("img.qrcode").attr("src", "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" + encodeURIComponent(stui.browser.url) + "")
		}
	},
	common: {
		bootstrap: function() {
			$.getScript(maccms.path+"/template/free1.0_wap/js/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript(maccms.path+"/template/free1.0_wap/js/headroom.min.js", function() {
				$("#header-top", function() {
